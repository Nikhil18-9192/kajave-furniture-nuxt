      ...
      <client-only>
        ...
        >
          ...
          <md-field md-theme="kajave">
            ...
            <md-input name="mobile" v-model="mobile" required></md-input>
          </md-field>
          <md-field md-theme="kajave">
            <label>Email</label>
            <md-input
...
<script>
import { quoteFormValidation } from "@/utils/validation";
export default {
  name: "ContactForm",
  data() {
    return {
    ...
    submitForm: function(event) {
      ...
      this.submitToServer()
        .then(() => {
          this.sending = false;
          this.$toast.success(
            "Thank you for contacting us! We will respond you as soon."
          );
        })
        .catch(() => {
          this.sending = false;
